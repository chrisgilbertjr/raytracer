...
main()
{
    ...
    Demo_CornellBox("14_CornellBox2500.bmp", 2500); /// Warning! no acceleration structure is used to this takes a LONG time to render.
    //Demo_CornellBox("14_CornellBox.bmp", 5000);     /// Warning! no acceleration structure is used to this takes a LONG time to render.
